...
<div data-role="page" id="Create">
    ...
    <div data-role="content" style="margin-bottom:30px">
        <form action="<?php echo $this->createUrl('updateDo');?>" method="post" data-ajax="false" enctype="multipart/form-data" id="form1">
            ...
            <div id="gj_item" style="display: <?php echo $model->id ? 'block' : 'none';?>">
             ...
             <div data-role="fieldcontain">
                <input data-val="true" data-val-length="长度不能超过100个字符" data-val-length-max="100" data-val-regex="请输入正确的邮箱格式" data-val-regex-pattern="^\w+((-\w+)|(\.\w+))*\@[A-Za-z0-9]+((\.|-)[A-Za-z0-9]+)*\.[A-Za-z0-9]+$"  id="email" name="email" placeholder="邮箱(选填)" type="text" value="<?php echo $model->email;?>" />
          ...
          <?php if($model->id){?>
          	<div data-role="fieldcontain">
              <span>头像：</span><input type="file" id="upphoto" name="upphoto" /><span class="uploading">正在上传，请稍候...</span><span id="upinfo" style="display:none; color:Red;"></span>
            ...
            <div data-role="fieldcontain">
              <span><img src="<?php echo $model->avatar;?>" style="width:80px; height:80px;" id="u_uphoto" /></span>
            </div>
            <div data-role="fieldcontain" style="display:none;">
                <input type="text" id="avatar" name="avatar" />
            </div>
            <p><!-- 上传的图片文件不能大于3M，支持的图片格式包括:jpg、gif、png。 --></p>
           <?php }?>
            </div>
           

            <p>
                <input type="submit" value="<?php echo $model->id ? '保存设置' : '生成微名片';?>" data-theme="b" id="upd_submit"/>
    ...
    <div id="sharebg">&nbsp;</div>
    <div id="sharebox">
        <img src="static/weixin/follow2.png" />
    </div>
</div>
<div id="operate-ok"></div>
<script type="text/javascript" src="static/weixin/jquery.form.js"></script>
<script>
$(function() {
