			...
			<div class="conArea">
				<div class="searchBox">
				   <?php $form=$this->beginWidget('CActiveForm', array('method'=>'get','action'=>$this->createUrl('index'),'htmlOptions'=>array('class'=>'xhform initform'),'enableAjaxValidation'=>true,'enableClientValidation'=>true,)); ?>
					<?php echo $form->textField($model, 'keyword', array('id'=>'sword', 'class'=>'inp1 nofocus','size'=>40,'placeholder'=>'请输入姓名或手机号码')); ?>
				    <?php echo CHtml::submitButton('搜 索', array('class'=>'btn1')) ?>
				    <span class="txs">一共查询到 <?php echo $count;?> 条数据&nbsp;&nbsp;
				    总转发数：<?php echo $stat['share_counts'];?>&nbsp;&nbsp;总浏览数<?php echo $stat['views'];?>
				    </span>
				    <?php $this->endWidget(); ?>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
							...
							?>
									<tr id="tr_<?php echo $val->id;?>">
										...
										<td>
										   <a href="<?php echo $this->createUrl('view',array('id'=>$val->id));?>">查看详细</a>
