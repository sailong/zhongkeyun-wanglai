...
<?php $this->widget('ext.kindeditor.KindEditorWidget',array(
	...
	<div class="brand">当前位置：首页 > <em>编辑文章&nbsp;>&nbsp;</em></div>
	<div class="conArea">
	<div class="content-box">
		<div class="content-box-header">
			<h3>编辑文章&nbsp;&nbsp;&nbsp;&nbsp;<a href="/admin/article/index">返回列表</a></h3>
		</div>
		<div class="content-box-content">


		<form enctype="multipart/form-data" id="member-form" action="/admin/article/updatedo" method="post">	
		...
		<tr>
			...
			<td>
				<input size="100" style="height:20px;" name="title" id="title" type="text" maxlength="100" value="<?php echo $model->title;?>" />			
			</td>
			<td width="30%">
		...
		<tr>
			...
			<td>
				<textarea name="content" id="content"><?php echo $model->content->content;?></textarea>			
			</td>
			<td width="30%">
		...
		<tr >
			...
			<td>
				<div class="row buttons">
					<input type="submit" name="yt1" id="submit_but" value="提交" />	
				</div>
			</td>
		</tr>
